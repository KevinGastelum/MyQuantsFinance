...
1. **[MLSentiment Strategy](https://github.com/KevinGastelum/MyQuantsFinance/blob/main/2_strategies/strat_sentiment_lumibot.py)** - Analyzes market mood through news and social media for trading signals using FinBert 💬.
   <img src="data\MLSentiment_spread.png">
